...
<section class="container-fluid" id="learn-more">
    <article class="row d-flex justify-content-center">
      ...
      <div class="col-lg-4 col-md-4 col-12 collapse-style">
            <img  src="<?php echo get_template_directory_uri(); ?>/images/icon_retailer.png" alt="VOC Free Icon" title="VOC Free Icon"/>
            <p><a class="btn btn-primary" href="#" role="button">Become a Retailer</a></p>
      </div>

      <!-- === FAQ ===-->
      <div class="col-lg-4 col-md-4 col-12 collapse-style">
        <img  src="<?php echo get_template_directory_uri(); ?>/images/icon_faq.png" alt="VOC Free Icon" title="VOC Free Icon"/>
        <p><a class="btn btn-primary" href="#" role="button">FAQs</a></p>
      </div>

      <!-- === Chat ===-->
      <div class="col-lg-4 col-md-4 col-12 collapse-style">
        <img  src="<?php echo get_template_directory_uri(); ?>/images/icon_phone.png" alt="VOC Free Icon" title="VOC Free Icon"/>
