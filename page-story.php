...
<!-- ======================= Company Values ==================-->
  <section class="container-fluid p-4" id="company-values">
    ...
    <div class="row justify-content-around">
      ...
      <div class="col-md-3 text-center" id="value">
        <a href="https://www.countrychicpaint.com/pages/our-story" target="blank"><img class="value" src="<?php echo get_template_directory_uri(); ?>/images/recycle.png" alt="recycle" title="recycle"/></a>
      ...
      <div class="col-md-3 text-center" id="value">
        <a href="https://www.countrychicpaint.com/pages/our-story" target="blank"><img class="value" src="<?php echo get_template_directory_uri(); ?>/images/house.png" alt="house" title="house"/></a>
      ...
      <div class="col-md-3 text-center" id="value">
        <a href="https://www.countrychicpaint.com/pages/our-story" target="blank"><img class="value"src="<?php echo get_template_directory_uri(); ?>/images/heart.png" alt="heart" title="heart"/></a>
