...
<!-- ======================= Company Values ==================-->
  ...
  <main class="container-fluid" id="learn-more">
    ...
    <section class="col-lg-3 col-md-3 col-12 collapse-style">
      <img  src="<?php echo get_template_directory_uri(); ?>/images/icon_economy.png" alt="Economy Icon" title="Economy Icon"/>
  ...
  <section class="col-lg-3 col-md-3 col-12 collapse-style">
    <img  src="<?php echo get_template_directory_uri(); ?>/images/icon_heart.png" alt="Heart Icon" title="Heart Icon"/>
